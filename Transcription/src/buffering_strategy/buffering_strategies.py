...
class SilenceAtEndOfChunk(BufferingStrategyInterface):
    ...
    def process_audio(self, websocket, vad_pipeline, asr_pipeline, connected_clients, room_id):
        """
        ...
        if len(self.client.buffer) > chunk_length_in_bytes:
            ...
            asyncio.create_task(
                self.process_audio_async(websocket, vad_pipeline, asr_pipeline, connected_clients, room_id))

    async def process_audio_async(self, websocket, vad_pipeline, asr_pipeline, connected_clients, room_id):
        """
