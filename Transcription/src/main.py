...
def main():
    ...
    server = Server(vad_pipeline, asr_pipeline_map, host=args.host, port=args.port, sampling_rate=16000, samples_width=2, certfile=args.certfile, keyfile=args.keyfile)
